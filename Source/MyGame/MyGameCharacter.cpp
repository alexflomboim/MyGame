...
AMyGameCharacter::AMyGameCharacter()
{
	...
	//GEngine->AddOnScreenDebugMessage(-1, 5.f, FColor::Red, TEXT("This is an on screen message123 4!"));
...
UAbilitySystemComponent* AMyGameCharacter::GetAbilitySystemComponent() const
{
...
void AMyGameCharacter::PossessedBy(AController* NewController)
{
...
void AMyGameCharacter::UnPossessed()
{
	Super::UnPossessed();
	if (const ATPPlayerState* TPPlayerState = GetPlayerState<ATPPlayerState>())
	{
